...
export const buttonVariantStyles: Record<ButtonVariant, string> = {
  primary: "bg-dark text-on-dark hover:bg-dark-hover focus-visible:ring-dark",
  secondary: "bg-surface text-ink hover:bg-surface-muted focus-visible:ring-ink",
  accent: "bg-accent text-ink hover:bg-accent-hover focus-visible:ring-accent",
};
